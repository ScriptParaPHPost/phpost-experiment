...
if (!defined('PHPOST_CORE_LOADED')) exit('No se permite el acceso directo al script');
...
class tsAdmin {
   ...
   */
   ...
   public function newTema() {
      ...
      */
      ...
      $url = $tsCore->settings['url'] . '/views/' . $path;
   ...
   */
   ...
   public function ChangeNick_o_no() {
      global $tsCore, $tsNotificaciones;
      # ID del nick
      ...
      if ($_POST['accion'] === 'aprobar') {
         ...
         $tsNotificaciones->setAviso($datos['user_id'], 'Cambio realizado', $aviso, 4);
         //ENVIAMOS CORREO
      ...
      # Denegamos
         ...
         $tsNotificaciones->setAviso($datos['user_id'], 'Cambio realizado', $aviso, 3);
         //ENVIAMOS CORREO
