                                ...
                                {if $tsSave}<div style="display: block;" class="mensajes ok">Tus cambios han sido guardados.</div>{/if}
                                    ...
                                    <form action="" method="post" id="admin_form" autocomplete="off">
                                    	...
                                    	<label for="ai_path">Nombre de la carpeta donde esta el tema:<br /><i>{$tsConfig.url}/views/</i></label> <input type="text" id="ai_path" name="path" value="{$tsTema.t_path}" size="30" />
                                        <hr />
                                    ...
                                    <form action="" method="post" id="admin_form" autocomplete="off">
                                    	<label for="ai_path">Nombre de la carpeta donde esta el tema a instalar:<br /><i>{$tsConfig.url}/views/</i></label> <input type="text" id="ai_path" name="path" size="30" />
                                        <hr />
