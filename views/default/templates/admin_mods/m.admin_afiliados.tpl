		...
		<form action="" method="post" autocomplete="off">
			<fieldset>
				...
				<dl>
					...
					<dd><input type="text" id="af_name" name="a_titulo" value="{$tsAf.a_titulo}" /></dd>
				</dl>
				<dl>
					<dt><label for="af_url">Direcci&oacute;n:</label></dt>
					<dd><input type="text" id="af_url" name="a_url" value="{$tsAf.a_url}" /></dd>
				</dl>
				<dl>
					<dt><label for="af_banner">Banner:</label><br /><span>Imagen del afiliado:</span></dt>
					<dd><input type="text" id="af_banner" name="a_banner" value="{$tsAf.a_banner}" /></dd>
				</dl>
				<dl>
					<dt><label for="af_desc">Descripci&oacute;n:</label><br /><span>Descripci&oacute;n de la comunidad afiliada</span></dt>
					<dd><textarea name="af_desc" id="a_descripcion" rows="3" cols="40">{$tsAf.a_descripcion}</textarea></dd>
				</dl>
				<hr />
