				<div class="clearbeta lastPosts">
					...
					<div class="body">
						<ul>
							...
							<li class="categoriaPost" style="background-image:url({$tsRoutes.images}/categorias/{$p.c_img}); {if $p.post_status == 3} background-color:#f1f1f1; {elseif $p.post_status == 1}background-color:coral;{elseif $p.post_status == 2} background-color:rosyBrown;{elseif $p.user_activo == 0} background-color:burlyWood;{elseif $p.user_baneado == 1} background-color:orange;{/if}" >
